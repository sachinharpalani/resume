...
\cvitem{Languages}{Python, JS, PHP}
\cvitem{Frameworks}{Flask(Python), Django(Python), Knockout JS, Laravel(PHP)}
\cvitem{Libraries}{Boto3, Zappa, Celery, Redis, Bootstrap}
\cvitem{Databases}{AWS Dynamodb, PSQL, MongoDB, MySQL}
\cvitem{Tools}{Git, Jira, Graylog, Sentry, AWS Cloudwatch}
...
\cventry {March'2020--Present}{houm.me}
...
\cventry {Oct'2018--March'2020}{Ultron}
{Technology: Python, Django, Knockout JS, Redis, Celery}{}{}
%{Ultron is a inhouse task-based CRM developed for helping advisors connect with right customers at the right time.}
{\begin{itemize}
%\item Worked closely with business team
...
\cventry {Jul'2017--Oct'2018}{Immerz Math}
