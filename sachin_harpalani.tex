...
\cvitem{Frameworks}{Django(Python), Knockout JS, Laravel(PHP)}
\cvitem{Libraries}{Celery, Redis, Bootstrap}
\cvitem{Databases}{PSQL, MongoDB, MySQL}
...
\cventry {Oct'2018--Present}{Ultron}
